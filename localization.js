...
const formatter2 = new Intl.ListFormat('en', { style: 'short', type: 'disjunction' });
...
The DisplayName object is useful for consistent translation of language, region and script display names.*/

//Example:
const languagesInHindi = new Intl.DisplaNames(['hi'], { type: 'language' });
...
//Example 
const regionNameInTamil = new Intl.DisplayNames(['ta'], { type: 'region' });
console.log(regionNamesInTamil.of('IN'));
// expected output: India(in tamil)

/*
In the above example, the region India's display name is translated and printed in Tamil.
The regions display name tobe translated are mentioned using its region code.
Here 'IN' is the region code for India.

    Type:
    Default Type is Language.Possible values are,language, region, script, currency
*/